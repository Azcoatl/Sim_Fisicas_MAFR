## Conceptos
Se ven conceptos ya visto en el proyecto de "prueba_sfml" y en el de "hola_joints". Se usa la clase Cube, eventos de teclado y joints de revolución, de distancia y prismáticas.
###### b2PulleyJointDef
Esta clase nos permite crear una articulación de polea. La pulley joint nos sirve para simular un sistema de poleas con dos objetos.
## Código
Este código simula una maquina de Rube Goldberg. Al iniciar el programa empieza inmediatamente la simulación, con un cubo, impulsado por un motor del RevoluteJointDef, golpeando a otro cubo haciendo que salga disparado y golpeando a otro cubo, que tiene aplicado un PricmaticJointDef para que solo se pueda mover en su eje x, al llegar a su limite alcanza a pegarle a otro cubo, conectado mediante una DistanceJointDef a un cubo justo abajo, haciendo que caiga, pero debido a su joint gira sobre sobre el cubo al que está anclado debido al impulso que le dio el cubo anterior, y gracias a la gravedad baja y le pega a un domino que inicia una secuencia de caída de dominós, y el último domino cae sobre una plataforma que tiene aplicada la PulleyJointDef, haciendo que por el peso baje y accionando la polea levantando la otra pieza hasta llegar al inicio donde el primer cubo que se encuentra girando debido al motor y metiéndose en su camino haciendo que se atore y se detenga. Siendo estos todos los eventos presentes en la simulación.
```
...
int main() {  
    ...
    // Articulacion de Rotacion  
      // Objetos en uso    Cube cube1(world, 200, 200, 0, 10.0f, 10.0f, 10.0f, 10.0f, sf::Color::Yellow);  
    ...
    // Articulacion Prismatica  
      // Objetos en uso    Cube cube5(world, 480, 290, 0, 70.0f, 10.0f, 70.0f, 10.0f, sf::Color::Green);  
    ...
    // Articulacion de Distancia  
      // Objetos en uso    Cube cube7(world, 800, 280, 1, 10.0f, 10.0f, 10.0f, 10.0f, sf::Color::Blue);  
    ...
    // Articulación de Polea  
      // Objetos en uso    Cube cube11(world, 170, 320, 1, 10.0f, 20.0f, 10.0f, 20.0f, sf::Color::Red);  
